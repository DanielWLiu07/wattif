import { Wrench, Zap, Map as MapIcon, Crosshair, FolderOpen, UploadCloud } from "lucide-react";
    ...
    <div className="pointer-events-auto flex h-full w-[300px] flex-col p-3">
      <Card className="glass flex min-h-0 flex-1 flex-col overflow-hidden">
        <Tabs defaultValue="build" className="flex min-h-0 flex-1 flex-col">
          <TabsList className="m-1.5 grid grid-cols-6 gap-0.5">
            ...
            <TabsTrigger value="data" className="flex-col gap-0.5 px-0.5 py-1 text-[10px]">
              <UploadCloud className="h-3.5 w-3.5" /> Data
            </TabsTrigger>
