...
export const landingStats: LandingStat[] = [
  ...
  },
  {
    ...
    detail:
      "Neighbourhoods in the top energy-burden tier (index ≥ 0.75) — low income + high renter share.",
  ...
  // --- Modelled estimates (must read as estimates, not measurements) ---
  {
    ...
    raw: 9.9,
    unit: "TWh/yr",
    label: "modelled residential demand",
    detail: "Baseline residential electricity demand (~825 GWh/month) across all 140 zones.",
